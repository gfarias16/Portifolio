...
O projeto é uma apresentação pessoal e não possui regras de negócio transacionais identificadas.

## Comportamentos funcionais comprováveis
...
- Somente canais públicos confirmados podem ser exibidos; GitHub, LinkedIn, e-mail profissional e WhatsApp estão validados.
...
- O currículo só pode ser publicado após confirmação explícita e revisão de dados pessoais; a versão atual recebeu essa autorização.
