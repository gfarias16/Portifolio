...
Portfólio de Gabriel Farias é uma página profissional estática em português para apresentar perfil, tecnologias, formação, projetos, áreas de atuação e contato.
...
- `script.js`: menu mobile, indicação da seção ativa e interação do carrossel magnético.
- `img_eu.jpg`: fotografia principal local.
- `curriculo/Curriculo14.01.2026.pdf`: currículo público disponibilizado para download com nome amigável.
- Ícones essenciais em CSS e SVG inline, sem dependência de CDN.

Não há backend, banco ou processo de build.
